...
- PASS: technically runnable and wrapper-ready.
...
| wucc009_gene_pair_methods | BACKLOG | mixed | https://github.com/wucc009/Implementation-and-comparison-of-gene-pair-methods | Candidate source for gene-pair method implementations; inspect after core wrappers are stable. |
